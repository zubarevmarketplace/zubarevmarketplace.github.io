    ...
    <Layout currentPage="calculator">
      ...
      <section className="relative z-10 px-4 md:px-8 py-10 md:py-16 max-w-[1240px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          ...
          <div
            className={`xl:col-span-6 p-5 md:p-6 bg-[#0B141C]/75 supports-[backdrop-filter]:bg-white/[0.06] border rounded-3xl space-y-4 transition-all duration-300 ${flash ? "border-cyan-400/40 shadow-[0_0_0_1px_rgba(34,211,238,0.15)]" : "border-white/10"}`}
          >
